...
def train_segmentor(model,
    ...
    #     same_lr_p = []
    #     half_lr_p = []
    #     for i, (n, t) in enumerate(zip(p['param_names'], p['params'])):
    #         if n in pretrained_keys:
    #             half_lr_p.append({'i': i, 'n': n, 't': t, 'p': p})
    #         else:
    #             same_lr_p.append({'i': i, 'n': n, 't': t, 'p': p})
    #     params_tmp = []
    #     param_names_tmp = []
    #     for temp_dic in half_lr_p:
    #         params_tmp.append(temp_dic['t'])
    #         param_names_tmp.append(temp_dic['n'])
    #     if params_tmp:
    #         p_copy = p.copy()
    #         p_copy['params'] = params_tmp
    #         p_copy['param_names'] = param_names_tmp
    #         p_copy['lr'] /= 10
    #         new_param_groups.append(p_copy)
    #
    #     params_tmp = []
    #     param_names_tmp = []
    #     for temp_dic in same_lr_p:
    #         params_tmp.append(temp_dic['t'])
    #         param_names_tmp.append(temp_dic['n'])
    #     if params_tmp:
    #         p_copy = p.copy()
